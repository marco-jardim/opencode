...
export namespace Flag {
  ...
  export const OPENCODE_DISABLE_CLAUDE_CODE_COMMANDS =
    OPENCODE_DISABLE_CLAUDE_CODE || truthy("OPENCODE_DISABLE_CLAUDE_CODE_COMMANDS")
  export const OPENCODE_DISABLE_EXTERNAL_COMMANDS =
    OPENCODE_DISABLE_CLAUDE_CODE_COMMANDS || truthy("OPENCODE_DISABLE_EXTERNAL_COMMANDS")
